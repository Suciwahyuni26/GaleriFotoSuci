            ...
            <div class="row">
                <div class="col-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="koneksi_foto.php" method="POST" enctype="multipart/form-data">
                                <label class="form-label">Judul Foto</label>
                                <input type="text" name="JudulFoto" class="form-control" required>
                                <label class="form-label">Deskripsi Foto</label>
                                <textarea class="form-control" name="DeskripsiFoto" required cols="30" rows="4"></textarea>
                                ...
                                <button type="submit" class="btn btn-danger mt-2" name="tambahfoto"> 
                                    Simpan
                                </button>                                                
                            </form>
                        </div>
                          ...
                          <table class="table">
                            ...
                            <tbody>
                              ...
                              ?>
                                <tr>
                                  <td><?php echo $no++ ?></td>
                                  <td><img src="uploads/<?php echo $data['LokasiFile'] ?>" width="100"></td>
                                  ...
                                  <td>
                                      ...
                                      <div class="modal-dialog">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            <form action="koneksi_foto.php" method="POST">
                                              ...
                                              <select class ="form-control" name="AlbumID">
                                                ...
                                                <?php
                                                  $UserID = $_SESSION['UserID'];
                                                  $sql_album = mysqli_query($conn, "SELECT * FROM  album WHERE UserID='$UserID'");
                                                  while($DataAlbum = mysqli_fetch_array($sql_album)){
                                                ?>
                                                <option <?php if ($DataAlbum['AlbumID'] == $data['AlbumID']) {?> selected="selected"
                                                  <?php } ?> value = "<?php echo $DataAlbum['AlbumID'] ?> ">
                                                  <?php echo $DataAlbum['NamaAlbum'] ?>
                                                </option>
                                                <?php } ?>
                                              </select>
                                              ...
                                              <div class = "row">
                                                <div class="col-md-4">
                                                  <img src="uploads/<?php echo $data['LokasiFile'] ?>" width="100">
                                                </div>
                                    ...
                                    <div class="modal-footer">
                                    <button type="submit" name="hapus" class="btn-primary">Hapus Data</button>
                                      </form>
                                    </div>
                                    </div>
                                    </div>
